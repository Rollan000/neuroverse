...
function switchMode(mode, event) {
  // DIAGNOSTIC
  console.log('[switchMode CORE] called with mode:', mode);
...
if (mode === 'review') {
  ...
  if (mode === 'casino') {
    const _el = document.getElementById('casinoMode');
    console.log('[switchMode] casino branch - element:', _el, 'has hidden:', _el ? _el.classList.contains('hidden') : 'N/A');
    if (_el) _el.classList.remove('hidden');
    console.log('[switchMode] after remove - has hidden:', _el ? _el.classList.contains('hidden') : 'N/A');
  }
  if (mode === 'inventory') {
