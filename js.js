...
if (mode === 'review') {
  ...
  if (mode === 'casino') {
    var _ce = document.getElementById('casinoMode');
    if (_ce) {
      _ce.classList.remove('hidden');
      var _cs = getComputedStyle(_ce);
      console.log('[CORE] casino after-remove: display='+_cs.display+' opacity='+_cs.opacity+' h='+_ce.classList.contains('hidden'));
    }
  }
  if (mode === 'inventory') {
