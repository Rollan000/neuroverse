...
let cursorVariantChoice   = (function(){ try { return JSON.parse(localStorage.getItem('cursorVariantChoice') || '{}'); } catch(_){ return {}; } })();
...
// equippedCursor declared early (see top of file)
