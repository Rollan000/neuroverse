...
const DAILY_QUESTS_DEF = [
  { id: 'q_mcq_10',      desc: 'Answer 10 MCQ correctly',        target: 10, track: 'mcq_correct',    reward: 50  },
  { id: 'q_review_5',    desc: 'Review 5 cards',                  target: 5,  track: 'review_graded',  reward: 40  },
  { id: 'q_kana_session', desc: 'Complete a kana session',         target: 1,  track: 'kana_complete',  reward: 60  },
  { id: 'q_trace_5',     desc: 'Trace 5 kanji correctly',          target: 5,  track: 'trace_correct',  reward: 55  },
  { id: 'q_streak_10',   desc: 'Reach a 10-answer MCQ streak',    target: 10, track: 'mcq_streak',     reward: 80  },
  { id: 'q_flash_5',     desc: 'Mark 5 flashcards as known',      target: 5,  track: 'flash_known',    reward: 35  },
];
